  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <?php if($connect && $responsable){ ?>
          ...
          <li class="nav-item">
            <a class="nav-link active" href="news.php">AJOUTER ANNONCE</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="demrec.php">DEMANDES RECRUTEMENT</a>
          </li>
        ...
        if($connect && $employer){ ?>
          <li class="nav-item">
            <a class="nav-link" href="profileemp.php">PROFILE</a>
        </li>
