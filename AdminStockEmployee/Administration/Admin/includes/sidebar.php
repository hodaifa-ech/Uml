  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      ?>
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-info" href="commande.php">
            ...
            <span class="nav-link-text ms-1">ajouter commandes</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white active bg-info" href="cmdrecu.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-users"></i>
            </div>
      ...
      ?>
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-info" href="four.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-gamepad"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-info" href="cmds.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-gamepad"></i>
            </div>
            <span class="nav-link-text ms-1">comandes envoyées</span>
          </a>
        </li>
      <?php
      }
