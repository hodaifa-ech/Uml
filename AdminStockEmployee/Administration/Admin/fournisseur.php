  ...
  <table class="table">
    ...
    <tbody class="table-group-divider">
      ...
      if (isset($_POST['validate'])) {
        ...
        $sql = "SELECT * FROM fournisseurs WHERE id_four = :inputValue OR nom = :inputValue OR prenom = :inputValue OR email = :inputValue OR status=:inputValue ";
      ...
      if (isset($_POST['submit'])) {
        ...
        if (count($rows) > 0) {
          ...
          if ($pass != $cpass) {
            ...
            $insert = "INSERT INTO fournisseurs(nom,prenom, email, password,image) VALUES (:nom, :prenom, :email, :password, :file_name)";
            ...
            echo "<div class='alert alert-success'>Le fournisseur a été ajoutee avec succès!</div>";
