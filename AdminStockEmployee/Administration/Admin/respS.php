        ...
        while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
            ...
            ?>
              <tr>
                  ...
                  <td>
                    <button class="btn  btn-info text-white"><a style="text-decoration:none;" href="updateRstock.php?updateid=<?php echo $id_respS;?>">update</a></button>
...
if(isset($_POST['submit'])){
    ...
    if (count($rows) > 0) {
      ...
      $user_role='ResponsableStock';
       ...
       echo "<div class='alert alert-success'>Le responsable de stock a été ajoutee avec succès!</div>";
