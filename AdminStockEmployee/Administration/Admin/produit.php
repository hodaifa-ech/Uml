...
<div class="container1" id="userTable">
  ...
  <?php
include 'config/dbsihame.php'; // Use include instead of @include to see any errors
        ...
        while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
            ...
            ?>
              <tr>
                  ...
                  <td><img src="../images/<?php echo $image ?>" alt="" width="60px" height="60px"></td>
                  <td><?php echo $description ?></td>
                  <td>
                    <button class="btn  btn-info text-white"><a style="text-decoration:none;" href="updatePr.php?updateid=<?php echo $id_produit;?>">update</a></button>
                    <button class="btn  btn-info text-white"><a style="text-decoration:none;" href="deletePr.php?deletedid=<?php echo $id_produit;?>">delete</a></button>
                  </td>
              </tr>
            <?php
        }
